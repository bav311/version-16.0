...
function myDisplayDialog(myObjectList){
	...
	with(myDialog.dialogColumns.add()){
		...
		with(dialogRows.add()){
			...
			with(dialogColumns.add()){
				var myRowGutterField = measurementEditboxes.add({editValue:11.339, editUnits:MeasurementUnits.millimeters});
			}
		}
		with(dialogRows.add()){
			with(dialogColumns.add()){
			...
			with(dialogColumns.add()){
				var myColumnGutterField = measurementEditboxes.add({editValue:11.339 , editUnits:MeasurementUnits.millimeters});
			}
		}
		with(dialogRows.add()){
			with(dialogColumns.add()){
