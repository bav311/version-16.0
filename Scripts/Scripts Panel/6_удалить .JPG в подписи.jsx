...
function main() {
	...
	// Query [[Удалить JPG в подписи]] -- If you delete this comment you break the update function
	try {
		app.findChangeGrepOptions.properties = ({includeFootnotes:true, kanaSensitive:true, widthSensitive:true});
		app.findGrepPreferences.properties = ({findWhat:"(.tif|.png|.jpg|.JPG|.psd|.jpeg)$"});
